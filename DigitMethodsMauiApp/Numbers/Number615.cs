...
{
    public class Number615 : Number61
    {
        public Number615(int variant = 1, int stepsCount = 2, double eps = 0.001) : base(variant, stepsCount, eps) { }
        public override string NumberName => "6.1.5";
